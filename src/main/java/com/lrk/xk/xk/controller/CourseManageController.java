...
public class CourseManageController {
    ...
    @ResponseBody
    @RequestMapping("/add")
    public Message add(@RequestParam String cno, @RequestParam String name,
        @RequestParam Byte weekStart, @RequestParam Byte weekEnd, @RequestParam Double credit) {
    ...
    @ResponseBody
    @RequestMapping("/upd")
    public Message upd(@RequestParam int id, String cno, String name, Byte weekStart, Byte weekEnd,
        Double credit) {
